//Stack de enteros SIN capacidad maxima en una lista
// Created by Jonas Glaubart
//
#ifndef UNTITLED5_STACKADTLIST_H      // por si se incluye dos veces
#define UNTITLED5_STACKADTLIST_H
...
int sizeStack(stackADT stack);         //cantidad de elementos
